...
from aux35 import OUT, SOURCE, SOURCE_SHA, MASTER, TARGET, ADDITIONS, REPLACEMENTS, instance
...
def main():
    ...
    expected.update({n: (r[0], r[3]) for n, r in ADDITIONS.items()})

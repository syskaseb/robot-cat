...
CACHE = ROOT / ('hardware/skorupa/'+REVISION+'/shape-cache' if REVISION in ('v28','v29','v30','v31','v32') else 'hardware/skorupa/v26/shape-cache')
SOURCE = ROOT / {'v25':'hardware/skorupa/v25/Kot_v25_DOMOWA_OSLONA.FCStd',
                 ...
                 'v32':'hardware/skorupa/v32/Kot_v32_NOS_TOF.FCStd'}[REVISION]
...
def main():
    ...
    plan_revision=REVISION if REVISION in ('v29','v30','v31','v32') else ('v27' if REVISION in ('v27','v28') else 'v24')
    ...
    for p0 in plan['components']:
        ...
        if REVISION in ('v29','v30','v31','v32') and p['stage']=='Motion_Tail_Yaw':
    ...
    report = dict(source_sha256=source_sha, geometry_cache_source_sha256=index['source_sha256'], components=rows,
                  ...
                  frozen_native_joints=['Rev_TailYaw29'] if REVISION in ('v29','v30','v31','v32') else [],

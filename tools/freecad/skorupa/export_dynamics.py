...
CACHE = ROOT / ('hardware/skorupa/'+REVISION+'/shape-cache' if REVISION in ('v28','v29','v30','v31','v32','v33','v34','v35') else 'hardware/skorupa/v26/shape-cache')
SOURCE = ROOT / {'v25':'hardware/skorupa/v25/Kot_v25_DOMOWA_OSLONA.FCStd',
                 ...
                 'v29':'hardware/skorupa/v29/Kot_v29_OGON_PROTOTYP.FCStd',
                 ...
                 'v34':'hardware/skorupa/v34/Kot_v34_PODPARCIE_OGONA.FCStd',
                 'v35':'hardware/skorupa/v35/Kot_v35_ZASILANIE_AUX.FCStd'}[REVISION]
...
def main():
    ...
    plan_revision=REVISION if REVISION in ('v29','v30','v31','v32','v33','v34','v35') else ('v27' if REVISION in ('v27','v28') else 'v24')
    ...
    for p0 in plan['components']:
        ...
        if REVISION in ('v29','v30','v31','v32','v33','v34','v35') and p['stage']=='Motion_Tail_Yaw':
    ...
    report = dict(source_sha256=source_sha, geometry_cache_source_sha256=index['source_sha256'], components=rows,
                  ...
                  frozen_native_joints=['Rev_TailYaw29'] if REVISION in ('v29','v30','v31','v32','v33','v34','v35') else [],

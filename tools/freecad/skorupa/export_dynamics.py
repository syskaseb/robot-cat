...
CACHE = ROOT / ('hardware/skorupa/v28/shape-cache' if REVISION=='v28' else 'hardware/skorupa/v26/shape-cache')
SOURCE = ROOT / {'v25':'hardware/skorupa/v25/Kot_v25_DOMOWA_OSLONA.FCStd',
                 'v27':'hardware/skorupa/v27/Kot_v27_BIODRA_ASSEMBLY.FCStd',
                 'v28':'hardware/skorupa/v28/Kot_v28_BIODRA_PETG.FCStd'}[REVISION]
...
def main():
    ...
    plan = json.loads((ROOT / ('hardware/skorupa/'+('v27' if REVISION in ('v27','v28') else 'v24')+'/assembly-plan.json')).read_text(encoding='utf8'))

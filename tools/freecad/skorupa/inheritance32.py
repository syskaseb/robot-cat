"""Compare 276 retained v31/v32 BReps; exclude ToF, muzzle, nose, front head."""
import json
from inheritance30 import ROOT,compare_text,sha

def main():
    old,new=(ROOT/'hardware/skorupa'/r for r in ['v31','v32'])
    ...
    names={r['name'] for r in plans[0]['components']}-{'ToF','Muzzle','Nose','HeadFront'};assert len(names)==276
    rows=[]

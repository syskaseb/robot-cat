# ODRZUCONY pierwszy szkic v33

Poniższy opis jest historyczny i zawiera nieaktualne deklaracje. Audyt wykazał
przesunięty o 5 mm drugi otwór mikrofonów, zablokowane narzędzia oraz odziedziczoną
wadliwą topologię głowy. To archiwum dowodów, NIE wersja do użycia ani druku.
Plik mastera wskazany w starym planie nie jest tu dołączony; zachowane złożenie
i raporty mają podpis źródła `33560ae…`. Aktualna praca znajduje się poziom wyżej.

# Historyczny opis: integralny pyszczek i mocowanie ReSpeaker
...
Od środka jest zaokrąglony otwór serwisowy 18×24 mm, R9, wycięty na 15 mm
od lokalnego Z=−5,6 w układzie ToF. Nie zastępuje on pełnego projektu wiązki.
...
- X=−157,078487; Y=−38,52 mm.

Podpory są integralne ze skorupą: belki 8×4 mm, słupki Ø5, otwory Ø2,4.
Dwa M2×12 przechodzą przez PCB i PETG, kończą się metalowymi nakrętkami.
...
tyłem. Rezerwy narzędzi nie są modelem konkretnego zakupionego klucza.
